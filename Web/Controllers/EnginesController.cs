...
namespace Web.Controllers
{
    public class EnginesController : Controller
    {
        ...
        public EnginesController(ProjectContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Name,CC,Id,CreatedAt,UpdatedAt")] Engine engine)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Name,CC,Id,CreatedAt,UpdatedAt")] Engine engine)
        {
            if (id != engine.Id)
            {
                return NotFound();
