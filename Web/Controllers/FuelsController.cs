...
namespace Web.Controllers
{
    public class FuelsController : Controller
    {
        ...
        public FuelsController(ProjectContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Type,Id,CreatedAt,UpdatedAt")] Fuel fuel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Type,Id,CreatedAt,UpdatedAt")] Fuel fuel)
        {
            if (id != fuel.Id)
            {
                return NotFound();
