...
namespace Web.Controllers
{
    public class TransmissionsController : Controller
    {
        ...
        public TransmissionsController(ProjectContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Type,Id,CreatedAt,UpdatedAt")] Transmission transmission)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Type,Id,CreatedAt,UpdatedAt")] Transmission transmission)
        {
